...
business_0 = 'На данный момент у вас 0 дел. Воспользуйтесь кнопкой ниже, чтобы добавить дело'
...
def list_of_business(business):
    business_not_0 = 'Ваши дела:\n'
    for i in business:
        business_not_0 = business_not_0 + i + '\n'
    return business_not_0
